...
export default function App() {
  ...
  return (
    <div className={`relative min-h-screen w-full font-serif text-saka-ink overflow-hidden transition-opacity duration-1000 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <footer className="absolute bottom-6 left-8 right-8 flex justify-between items-center text-[10px] md:text-xs text-saka-ink/50 tracking-[0.2em] font-sans uppercase">
          ...
          <div className="flex space-x-4">
            <a href="mailto:wushixuan238@gmail.com" className="hover:text-saka-ink/80 transition-colors duration-300" title="Email">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z" />
              </svg>
            </a>
            <a href="https://github.com/wushixuan238" target="_blank" rel="noopener noreferrer" className="hover:text-saka-ink/80 transition-colors duration-300" title="GitHub">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/in/yujun-pan-094756364/" target="_blank" rel="noopener noreferrer" className="hover:text-saka-ink/80 transition-colors duration-300" title="LinkedIn">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
